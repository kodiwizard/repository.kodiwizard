...
YOUTUBE_CHANNEL_ID_1 = "UCkhxWF5CTMUgxneqAFP96LQ"
YOUTUBE_CHANNEL_ID_2 = "UC7aZWaEkh1Ber9-BS4G_8ag"
YOUTUBE_CHANNEL_ID_3 = "PUkhxWF5CTMUgxneqAFP96LQ"
YOUTUBE_CHANNEL_ID_4 = "PLklwWZTPxmdJCmG-BUE0-Q3gqg-ON1qF-"
YOUTUBE_CHANNEL_ID_5 = "UCBwZiZK1LwZKWK-Jel1vSPQ"
YOUTUBE_CHANNEL_ID_6 = "PL1CCB5F6E49A1C4C9"
#----------------------------------------------------------------
...
# Add some YT Playlists (see we're using BASE as the url)
    Add_Dir( 
        name="NELK -Youtube", url=BASE2+YOUTUBE_CHANNEL_ID_1+"/", folder=True,
        icon="https://yt3.ggpht.com/-ZjmQmJlP8Qs/AAAAAAAAAAI/AAAAAAAAAAA/PsF1le_l1Ak/s900-c-k-no-mo-rj-c0xffffff/photo.jpg")

    Add_Dir( 
        name="LIFEOFNELK -Youtube", url=BASE2+YOUTUBE_CHANNEL_ID_2+"/", folder=True,
        icon="https://yt3.ggpht.com/-ZjmQmJlP8Qs/AAAAAAAAAAI/AAAAAAAAAAA/PsF1le_l1Ak/s900-c-k-no-mo-rj-c0xffffff/photo.jpg")

    Add_Dir( 
        name="mtvjesse -Youtube", url=BASE2+YOUTUBE_CHANNEL_ID_5+"/", folder=True,
        icon="https://yt3.ggpht.com/-MCBu-dI8ots/AAAAAAAAAAI/AAAAAAAAAAA/KAZslUdAi58/s288-c-k-no-mo-rj-c0xffffff/photo.jpg")

    Add_Dir( 
        name="Popular uploads", url=BASE+YOUTUBE_CHANNEL_ID_3+"/", folder=True,
        icon="https://i.ytimg.com/vi/oChIeqBFNvQ/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLAigbXA6O4w-AEMxePvVCmm5u7FxQ")

    Add_Dir( 
        name="Short Films and Music Videos", url=BASE+YOUTUBE_CHANNEL_ID_4+"/", folder=True,
        icon="https://i.ytimg.com/vi/7htlrbSIgT8/hqdefault.jpg")

    Add_Dir( 
        name="What The **** Moments", url=BASE+YOUTUBE_CHANNEL_ID_6+"/", folder=True,
        icon="https://i.ytimg.com/vi/8s99od9-qc4/hqdefault.jpg")
