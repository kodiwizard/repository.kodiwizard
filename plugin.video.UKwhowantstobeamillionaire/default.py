...
YOUTUBE_CHANNEL_ID_1 = "UCKSxNv7X_ewMbXgs134rCJA"
YOUTUBE_CHANNEL_ID_2 = "PLOA8H8Jl1whw3Y2PRtnjv2nC9j5yp8qW5"
YOUTUBE_CHANNEL_ID_3 = "PLOA8H8Jl1whxg0VAkjp5dcvIoQTbL-_2i"
YOUTUBE_CHANNEL_ID_4 = "PLOA8H8Jl1whzyCrUmYAOyfusnjFeMJ8xW"
YOUTUBE_CHANNEL_ID_5 = "PLOA8H8Jl1whysTS08sEnwSRt_pTPf3NxA"
...
# An example title/message we're going to send through to a popup dialog in the first Add_Dir item
    my_message= "{'title' : 'Who Wants To be a millionaire', 'msg' : \"For Help and Support & To Request anything for this addon Please reach us on Facebook Team X Kodi / @teamxkodi Twitter                                                                                                  If you click On Playlists in the sections within this addon you will get even more content\"}"
...
# Add some YT Playlists (see we're using BASE as the url)
    Add_Dir( 
        name="Who Wants To Be A Millionaire UK -Youtube", url=BASE2+YOUTUBE_CHANNEL_ID_1+"/", folder=True,
        icon="https://yt3.ggpht.com/-IDv4IAqeO-I/AAAAAAAAAAI/AAAAAAAAAAA/O64l4MdxCNk/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg")

    Add_Dir( 
        name="Classic Contestants", url=BASE+YOUTUBE_CHANNEL_ID_2+"/", folder=True,
        icon="https://yt3.ggpht.com/-IDv4IAqeO-I/AAAAAAAAAAI/AAAAAAAAAAA/O64l4MdxCNk/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg")

    Add_Dir( 
        name="Amazing Moments", url=BASE+YOUTUBE_CHANNEL_ID_3+"/", folder=True,
        icon="https://yt3.ggpht.com/-IDv4IAqeO-I/AAAAAAAAAAI/AAAAAAAAAAA/O64l4MdxCNk/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg")

    Add_Dir( 
        name="Biggest Wins", url=BASE+YOUTUBE_CHANNEL_ID_4+"/", folder=True,
        icon="https://yt3.ggpht.com/-IDv4IAqeO-I/AAAAAAAAAAI/AAAAAAAAAAA/O64l4MdxCNk/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg")

    Add_Dir( 
        name="Biggest Losses", url=BASE+YOUTUBE_CHANNEL_ID_5+"/", folder=True,
        icon="https://yt3.ggpht.com/-IDv4IAqeO-I/AAAAAAAAAAI/AAAAAAAAAAA/O64l4MdxCNk/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg")

    # Add_Dir( 
    #     name="Road Rangers", url=BASE2+YOUTUBE_CHANNEL_ID_6+"/", folder=True,
    #     icon="https://yt3.ggpht.com/-7aN80TWh5xA/AAAAAAAAAAI/AAAAAAAAAAA/PstSKoXZl3g/s288-c-k-no-mo-rj-c0xffffff/photo.jpg")

    # Add_Dir( 
    #     name="Haunted House Monster Truck", url=BASE2+YOUTUBE_CHANNEL_ID_7+"/", folder=True,
...
#           This Addon was Created By Team X Kodi 
#                 @teamxkodi Twitter
